...
XEN_DAEMON_SOURCES :=
XEN_DAEMON_SOURCES += ./xen-daemon/xen-daemon.go
XEN_DAEMON_SOURCES += ./syslog/syslog.go
XEN_DAEMON_SOURCES += ./system/system.go
XEN_DAEMON_SOURCES += ./guestmetric/guestmetric.go
XEN_DAEMON_SOURCES += ./guestmetric/guestmetric_linux.go
XEN_DAEMON_SOURCES += ./xenstoreclient/xenstore.go
